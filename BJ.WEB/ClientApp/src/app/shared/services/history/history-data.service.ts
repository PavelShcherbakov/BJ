...
export class HistoryDataService {
  ...
  public getAllGames(): Observable<GetAllGamesResponseHistoryView> {
    return this.http.get<GenericResponseView<GetAllGamesResponseHistoryView>>(Config.baseUrl + '/History/GetAllGames')
      .pipe(
        map(
          data => {
  ...
  public getGameInfo(getGameInfoHistoryView: GetGameInfoHistoryView): Observable<GetGameInfoResponseHistoryView> {
    return this.http.post<GenericResponseView<GetGameInfoResponseHistoryView>>(Config.baseUrl + '/History/GetGameInfo', getGameInfoHistoryView)
      .pipe(
        map(
          data => {
